// Express validator is simply an array of properties and validation logic applied to those properties.
...
export const createValidator: ValidationChain[] = [
  ...
  body('status')
    ...
    .withMessage('Status can only be todo, isProgress or completed'),
];
